...
import net.ninjaworks.ninjamod.screen.renderer.EnergyInfoArea;
import net.ninjaworks.ninjamod.screen.renderer.FluidStackRenderer;
import net.ninjaworks.ninjamod.util.FluidStack;
import net.ninjaworks.ninjamod.util.MouseUtil;

import java.util.Optional;

public class OperatorStationScreen extends HandledScreen<OperatorStationScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(NinjaMod.MODID, "textures/gui/operator_station_gui.png");
    private EnergyInfoArea energyInfoArea;
    private FluidStackRenderer fluidStackRenderer;

    public OperatorStationScreen(OperatorStationScreenHandler handler, PlayerInventory inventory, Text title) {
