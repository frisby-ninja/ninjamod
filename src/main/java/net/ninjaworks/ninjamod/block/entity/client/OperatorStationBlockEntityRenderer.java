package net.ninjaworks.ninjamod.block.entity.client;
...
public class OperatorStationBlockEntityRenderer implements BlockEntityRenderer<OperatorStationBlockEntity> {
    public OperatorStationBlockEntityRenderer(BlockEntityRendererFactory.Context context) {

    }

    @Override
    public void render(OperatorStationBlockEntity entity, float tickDelta, MatrixStack matrices,
        ...
        switch (entity.getCachedState().get(OperatorStationBlock.FACING)) {
